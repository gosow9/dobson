...
Report bugs at [https://github.com/gosow9/dobson/issues](https://github.com/gosow9/dobson/issues).
W
Stambling upon a Bug means encountering different behaviour than the expected/advertised one. When you are reporting a bug, please include the following infromation by filling in [the template](https://github.com/gosow9/dobson/.github/blob/master/.github/ISSUE_TEMPLATE/bug_report.md).
...
dobson could always use more documentation, whether as part of the official dobson docs, in docstrings, etc.
...
The best way to send feedback is to file an issue at [https://github.com/gosow9/dobson/issues](https://github.com/gosow9/dobson/issues).
...
Here's how to set up `dobson` for local development.

1. Fork the `dobson` repo on GitHub.
2. Clone your fork locally:

```bash
git clone git@github.com:gosow9/dobson.git
```
...
dobson is designed to do one thing, and do that one thing very well.
...
The roadmap located [here](https://github.com/gosow9/dobson/milestones?direction=desc&sort=due_date&state=open)
